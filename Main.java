...
class BubbleSortThread implements Runnable {
   ...
   private Vector < Integer > sortList ;
   private int a;
   private int b;
  ...
  void swap ( int a,int b ) {
      ...
      int temp = sortList.get(a).intValue() ;
      sortList.set( a, new Integer( sortList.get(b).intValue() ) ) ;
      sortList.set( b, new Integer( temp ) ) ;
  ...
  void bubbleSort( int head,int tail ) {
	...
	if ( sortList.get(i).intValue() > sortList.get( i+1 ).intValue() ) {
	        swap( i , i+1 ) ;
	        flag = false;
	} // if
...
class MergeSortThread implements Runnable {
  ...
  void Merge( int p,int q, int r ) {
       ...
       for( int i = 0 ; i < n1 ; i ++ ) 
         L.add( new Integer( sortList.get( p+i ).intValue() ) ) ;
         
       for( int i = 0 ; i < n2 ; i ++ ) 
         R.add( new Integer( sortList.get( q+1+i ).intValue() ) ) ;
         
         
       L.add( new Integer( Integer.MAX_VALUE ) ) ;
       R.add( new Integer( Integer.MAX_VALUE ) ) ;
       ...
       */
       ...
       for( int k = p ; k <= r ; k ++ ) {
        if(  L.get(i).intValue() <= R.get(j).intValue() ) {
          sortList.set( k , new Integer ( L.get(i).intValue() ) );
          i ++ ;
        } // if
          ...
          sortList.set( k , new Integer( R.get(j).intValue() ) );
          j ++ ;
        } // else
...
class Main {  // Please do not put 'public' before 'class'
  ...
  static String mtext = "" ;
  static Vector < Integer > sortList = new Vector < Integer > ();
  static int case1 ;
  ...
  public static void main( String[] args ) throws Throwable {
    ...
    for( int i = 0 ; i < sortList.size() ; i++ ) {
        G.Print( sortList.get(i).toString() + " " ) ;
        fp.write( sortList.get(i).toString() + " " ) ;
